    ...
    <div className="min-h-screen bg-cream text-primary font-sans" suppressHydrationWarning>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 lg:py-12">
        <header className="mb-6 sm:mb-10 lg:mb-12 text-center">
          <h1 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-serif mb-2 sm:mb-4 text-primary">Applied AI & Engineering</h1>
          <p className="section-description text-xs sm:text-sm lg:text-base">
        ...
        <section className="mb-8 sm:mb-12 lg:mb-16 text-center">
          <h2 className="text-base sm:text-lg lg:text-xl font-serif text-[#2d2624] mb-4 sm:mb-6 lg:mb-8 underline decoration-[#e7bc91]">Engineering Pillars</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
            <div className="accent-bar p-3 sm:p-4 lg:p-6">
              <h3 className="text-sm sm:text-base lg:text-lg font-semibold mb-2 sm:mb-3">Architecting Scalable RAG</h3>
            ...
            <div className="accent-bar p-3 sm:p-4 lg:p-6">
              <h3 className="text-sm sm:text-base lg:text-lg font-semibold mb-2 sm:mb-3">Production Full-Stack AI</h3>
              <p className="text-xs sm:text-sm lg:text-base text-secondary leading-relaxed">
        ...
        <section className="mb-8 sm:mb-12 lg:mb-16">
          <h2 className="text-base sm:text-lg lg:text-xl font-serif text-[#2d2624] mb-4 sm:mb-6 lg:mb-8">Selected Production AI Systems</h2>
          <div className="space-y-3 sm:space-y-4 lg:space-y-6">
            
            {/* POL-App Implementation */}
            <div className="card p-3 sm:p-4 lg:p-6">
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2 sm:mb-3 lg:mb-4 gap-1 sm:gap-2">
                <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-primary leading-tight">POL-App: Medical RAG Backend</h3>
                <span className="badge-accent text-xs whitespace-nowrap flex-shrink-0">Production Prototype</span>
              </div>
              <p className="text-xs sm:text-sm lg:text-base text-secondary mb-3 sm:mb-4 lg:mb-6">
            ...
            <div className="card p-3 sm:p-4 lg:p-6">
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2 sm:mb-3 lg:mb-4 gap-1 sm:gap-2">
                <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-primary leading-tight">IMV Lab: SDG Impact Assistant</h3>
                <span className="badge-accent text-xs whitespace-nowrap flex-shrink-0">Domain-Specific RAG</span>
              </div>
              <p className="text-xs sm:text-sm lg:text-base text-secondary mb-3 sm:mb-4 lg:mb-6">
            ...
            <div className="card p-3 sm:p-4 lg:p-6">
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2 sm:mb-3 lg:mb-4 gap-1 sm:gap-2">
                <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-primary leading-tight">UHH Tool Catalogue Discovery</h3>
                <span className="badge-accent text-xs whitespace-nowrap flex-shrink-0">Internal Tooling</span>
              </div>
              <p className="text-xs sm:text-sm lg:text-base text-secondary mb-3 sm:mb-4 lg:mb-6">
        ...
        <section className="mb-8 sm:mb-12 lg:mb-16">
          <h2 className="text-base sm:text-lg lg:text-xl font-serif text-[#2d2624] mb-4 sm:mb-6 lg:mb-8">Publications & Preprints</h2>
          <article className="card p-3 sm:p-4 lg:p-6 border-l-4 border-[#e7bc91]">
            <h3 className="text-xs sm:text-sm lg:text-base font-semibold mb-1 sm:mb-2 leading-tight">CollEX: A Multimodal Agentic RAG System Enabling Interactive Exploration of Scientific Collections</h3>
            <p className="text-xs font-bold text-accent uppercase tracking-widest mb-2 sm:mb-3 lg:mb-4">Published 2025 | ArXiv: 2504.07643</p>
            <p className="text-xs sm:text-sm lg:text-base text-secondary leading-relaxed mb-3 sm:mb-4 lg:mb-6">
        ...
        <section className="card-neutral p-3 sm:p-4 lg:p-6 mb-8 sm:mb-12 lg:mb-16">
          <h2 className="text-sm sm:text-base lg:text-lg font-semibold mb-3 sm:mb-4">System Design Approach</h2>
          <ul className="space-y-2 sm:space-y-3 lg:space-y-4 text-xs sm:text-sm lg:text-base text-secondary">
      ...
      <footer className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8 divider mt-8 sm:mt-12 lg:mt-16">
        <div className="max-w-7xl mx-auto flex flex-col gap-2 sm:gap-0 sm:flex-row justify-between items-center text-muted text-[8px] sm:text-[10px] lg:text-xs uppercase tracking-widest font-bold">
