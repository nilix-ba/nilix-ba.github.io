...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-cream text-primary font-sans" suppressHydrationWarning>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-12 pb-12 sm:pb-24">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-12 lg:gap-16">
          ...
          <div className="lg:w-1/2 space-y-6 sm:space-y-8">
            <div>
              <p className="text-xs sm:text-sm uppercase tracking-widest text-muted mb-2">{siteConfig.degree}</p>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif leading-tight text-primary">
                {siteConfig.name}
              </h1>
            </div>
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Link href={siteConfig.routes.research} className="btn-primary inline-block text-center px-4 sm:px-6 py-2 sm:py-3">
                Research
              </Link>
              <Link href={siteConfig.routes.contact} className="btn-secondary inline-block text-center px-4 sm:px-6 py-2 sm:py-3">
                Get in Touch
              </Link>
            </div>
          </div>
          ...
          <div className="lg:w-1/2 relative w-full">
            <div className="relative z-10 w-full aspect-square max-w-xs sm:max-w-sm md:max-w-md mx-auto overflow-hidden rounded-2xl sm:rounded-3xl lg:rounded-[3rem] shadow-xl sm:shadow-2xl border-4 sm:border-8 border-white">
              <img 
            ...
            <div className="absolute -bottom-6 -right-6 sm:bottom-auto sm:right-auto sm:-bottom-8 sm:-right-8 w-40 sm:w-56 lg:w-64 h-40 sm:h-56 lg:h-64 bg-accent rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-blob"></div>
          </div>
        </div>

        {/* Research Areas Section */}
        <section className="mt-16 sm:mt-24 lg:mt-32 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          <div className="card space-y-3 p-4 sm:p-6">
            ...
            <ul className="text-secondary space-y-1 sm:space-y-2 text-xs sm:text-sm">
      ...
      <footer className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8 divider mt-16 sm:mt-24 lg:mt-32">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center text-muted text-xs sm:text-sm gap-4">
